...
if(isset($_POST['btnLuu'])) {
    ...
    $resultInsert = mysqli_query($conn, $sqlInsert);
     ...
     try {
         ...
         $siteUrl = 'http://localhost:1000/StudyWSongXanhEB/';
         $body = <<<EOT
        <table>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <a href="http://localhost:1000/SongXanh/backend/pages/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                </td>
            </tr>
            <tr>
                <td>
